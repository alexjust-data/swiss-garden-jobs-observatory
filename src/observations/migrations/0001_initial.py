    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("location_street", models.CharField(blank=True, max_length=500)),
                ("location_locality", models.CharField(blank=True, max_length=200)),
                ("location_region", models.CharField(blank=True, max_length=200)),
                ("location_postal_code", models.CharField(blank=True, max_length=100)),
