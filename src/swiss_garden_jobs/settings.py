...
JOB_OBSERVATORY_OPERATIONAL_DB_IDENTITY_SHA256 = _env(
    "JOB_OBSERVATORY_OPERATIONAL_DB_IDENTITY_SHA256"
)
JOB_OBSERVATORY_RAW_LINEAGE_MANIFEST_SHA256 = _env("JOB_OBSERVATORY_RAW_LINEAGE_MANIFEST_SHA256")
